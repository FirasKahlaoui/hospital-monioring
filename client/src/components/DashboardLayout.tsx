...
import { LayoutDashboard, LogOut, PanelLeft, Users, UserRound, ShieldAlert, History, Camera, Loader2 } from "lucide-react";
...
export default function DashboardLayout({
  ...
  const { loading, user, login, loginWithEmail } = useAuth();
        ...
        <div className="flex flex-col items-center gap-8 p-8 max-w-md w-full">
          <div className="flex flex-col items-center gap-6">
            ...
            <p className="text-sm text-muted-foreground text-center max-w-sm">
              Enter your credentials or use Google to access the monitoring dashboard.
            </p>
          </div>
