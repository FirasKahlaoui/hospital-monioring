...
\begin{description}
	...
	\item[UC-7: Clinical Data Synchronization.]
	      Administrative users trigger synchronization between the local cache and the Firebase Firestore backend to ensure data consistency across multiple monitoring stations.
